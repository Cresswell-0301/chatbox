...
export default function Chatbox() {
  ...
  useEffect(() => {
    ...
    }, 100); //  change to set how long to display chaticon time
  }, []);

  // First Level Chat Start
    ...
    <div>
      <Main>
        ...
        <ContainerBox id="ContainerBox">
          ...
          {/* First Level Selection End */}

          {/* First Level Reply Start */}
          <RpyBox id="RpyBox">
            <P2 id="LeftRpy"></P2>
          </RpyBox>
          {/* First Level Reply End */}

          {/* Second Level Selection Start */}
          <MessageBoxRight2>
            <div id="Right2">
          ...
          {/* Second Level Selection End */}

          {/* Second Level Reply Start */}
          <RpyBox2 id="RpyBox2">
            <P2 id="LeftRpy2"></P2>
          </RpyBox2>
          {/* Second Level Reply Start */}
